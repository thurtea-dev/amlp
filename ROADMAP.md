...
| 0.13 | Grow efun table to FluffOS parity (~300 efuns) | `src/efun` | [ ] (in progress: 225 registered; this exact vendored reference build's own efun_defs.c lists 270 real names total, not ~300 -- see STATUS.md's 2026-08-22 entries) |
