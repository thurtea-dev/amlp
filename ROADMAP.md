...
| 0.13 | Grow efun table to FluffOS parity (~300 efuns) | `src/efun` | [ ] (in progress: 190 registered) |
...
Current baseline: **522 tests passing** (as of 2026-08-22). Every new slice
