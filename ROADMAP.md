...
| 0.13 | Grow efun table to FluffOS parity (~300 efuns) | `src/efun` | [ ] (in progress: 232 registered; this exact vendored reference build's own efun_defs.c lists 270 real names total, not ~300 -- see STATUS.md's 2026-08-22 entries. Remaining gap is now almost entirely prior-documented exclusions/deferrals: shadowed simul_efuns, TYPE_BUFFER/TYPE_CLASS architecture mismatches, unverifiable no-body efuns, and three dedicated-session candidates -- origin(), the real parser package, reload_object()) |
